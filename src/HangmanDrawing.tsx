...
const RIGHT_ARM = (
  <div
    style={{ width: "110px", height: "10px", background:"black" ,position: 'absolute', top: "150px", right: "-100px", rotate: "-30deg" }}
  />
)
const LEFT_ARM = (
  <div
...
export const  HangmanDrawing = ({ numberOfGuesses}: HangmanDrawingProps) => {
  return (
      <div style={{ position: "relative" }}>
        ...
        <div style={{ height: "50px", width: "10px", background:"black", position: "absolute" ,top: 0, left: "310px"}}></div>
